...
class StreamingRequestError extends Error {
    constructor(message: string) {
        super(message);
        this.name = 'StreamingRequestError';
    }
}
        ...
        try {
            await fetchEventSource('/api', {
                ...
                async onopen(response) {
                    ...
                    let message = 'Unable to generate summary right now.';
                    ...
                    throw new StreamingRequestError(message);
                },
                onmessage(ev) {
                    buffer += ev.data;
                    setOutput(buffer);
